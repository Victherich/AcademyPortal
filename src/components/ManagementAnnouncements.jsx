...
const ManagementAnnouncements = () => {
  ...
  return (
    <Container>
      {location.pathname==="/managementdashboard"&&<Title>{form.id ? 'Edit Announcement' : 'Create Announcement'}</Title>}
      {location.pathname!=="/managementdashboard"&&<Title>Announcements</Title>}
     {location.pathname==="/managementdashboard"&& <Form onSubmit={form.id ? handleEditSubmit : handleSubmit}>
        <Input
          type="text"
          placeholder="Title"
          value={form.title}
      ...
      <AnnouncementGrid>
        {announcements.map((announcement) => (
          <AnnouncementCard key={announcement.id}>
           ...
           { location.pathname==="/managementdashboard"&&<Button onClick={() => editAnnouncement(announcement)}>Edit</Button>}
           { location.pathname==="/managementdashboard"&&<Button onClick={() => deleteAnnouncement(announcement.id)}>Delete</Button>}
          </AnnouncementCard>
        ))}
      </AnnouncementGrid>
