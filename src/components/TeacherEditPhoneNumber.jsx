...
const TeacherEditPhoneNumberModal = ({ userId, showModal, setShowModal, fetchUserDetails }) => {
  ...
  const handleSave = async () => {
    if (!newPhoneNumber) {
     ...
     const loadingAlert = Swal.fire({text:"Please wait..."})
            ...
            const url = 'https://ephadacademyportal.com.ng/ephad_api/teacher_update_phone_number.php'
...
export default TeacherEditPhoneNumberModal;
