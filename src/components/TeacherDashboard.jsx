...
const TeacherDashboard = () => {
  ...
  const renderContent = () => {
    switch (activeMenu) {
      case 'profile':
        return <TeacherUserDetails managementID={teacherInfo.id}/>;
        // case 'departments':
        // return <Departments />;
        // case 'classes':
        // return <Classes />;
        ...
        return <StudentsByClass managementID={teacherInfo.id}/>;
        // case 'schoolFees':
        // return <SchoolFees />;
  ...
  return (
    <DashboardContainer>
      ...
      <Sidebar isOpen={menuOpen}>
        <SidebarHeader>Teacher Dashboard</SidebarHeader>
        <SidebarMenu>
          ...
          <SidebarMenuItem
            active={activeMenu === 'teacherFeedbacks'}
            onClick={() => handleMenuClick('teacherFeedbacks')}
          >
           Teacher Feedbacks
          </SidebarMenuItem>
